...
public class RightPositionAuto extends SequentialCommandGroup {
   ...
   */
  public RightPositionAuto(Drivetrain drivetrain, Intake intake, TurretRotator turretrotator, LimelightServo limelightservo, Launcher launcher, Hood hood) {
    ...
    super(
      ...
      new DriveDistance(156, drivetrain),
      new RevLauncher(0, launcher),
      new SetHoodAngle(0, hood),
      new SetTurretAngle(0, turretrotator),
